    ...
    class Code128 :IDisposable
    {
        ...
        private List<DataRow> FindStartorCodeCharacter(string s, ref int col)
        {
            ...
            else
            {
                ...
                foreach (DataRow row in this.C128_Code.Rows)
                {
                    ...
                    {
                        MessageBox.Show("EC128-1: " + ex.Message);
                        return null;
                    }//catch
                }//foreach                
                ...
                if (rows.Count <= 0)
                {
                    MessageBox.Show("EC128-2: Could not determine start character.");
                    return null;
                }
            }//else
        ...
        private void InsertStartandCodeCharacters()
        {
                        ...
                        while (error)
                        {
                            ...
                            catch
                            {
                                ...
                                if (col++ > CurrentCodeSet.ItemArray.Length)
                                {
                                    ...
                                    MessageBox.Show("No start character found in CurrentCodeSet.");
                                    return;
                                }
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("EC128-3: Could not insert start and code characters.\n Message: " + ex.Message);
                return;
            }//catch
        ...
        private string GetEncoding()
        {
            ...
            foreach (string s in _FormattedData)
            {
                ...
                if (E_Row == null || E_Row.Length <= 0)
                {
                    ...
                    MessageBox.Show("EC128-5: Could not find encoding of a value( " + s1 + " ) in C128 type ");
                    return string.Empty;
                }
